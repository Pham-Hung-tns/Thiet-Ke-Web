...
<head>
  ...
  <script src="./assets/js/quiz_listening_1.js"></script>
    ...
    <div class="container py-md-5 py-4">
      ...
      <div class="row justify-content-center">
        <ul id="accordion" class="accordion">
          ...
          <li>
            <div class="link"><i class="fa fa-mobile"></i>Listening topic: A bussiness interview<i
                class="fa fa-chevron-down"></i></div>
            <ul class="submenu">
              <div class="col-12 justify-content-center">
                <img src="./assets/images/imgListening1.jpg" class="align-item-center"
                  style="max-width: 800px; margin: 0 auto; display: block;" alt="">
                <audio controls>
                  <source src="./assets/audio/audioListening1.mp3" type="audio/mpeg">
                </audio>
      ...
      <div class="pagination-style text-center mt-5">
        <ul class="d-flex justify-content-center">
          ...
          <li><a class="active" href="Listening.php">1</a></li>
          <li>
            <a href="Listening_02.php">2</a>
          </li>
          <!-- <li>
            <a href="#page">3</a>
          </li> -->
          <li>
            <a href="Listening_02.php"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
            </a>
          </li>
        </ul>
      </div>
