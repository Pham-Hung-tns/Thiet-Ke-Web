...
<head>
  ...
  <script src="./assets/js/quiz_listening_2.js"></script>
    ...
    <div class="w3l-breadcrumb py-lg-5">
      <div class="container pt-4 pb-sm-4">
        ...
        <ul class="breadcrumbs-custom-path">
          ...
          <li class="active"><i class="fas fa-angle-right"></i>Listening</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <div class="w3l-grids-block-5 py-5">
    <div class="container py-md-5 py-4">
      <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
        <p class="text-uppercase">Listening Train</p>
        <h3 class="title-style">Lesson 2<?php
        require 'vendor/autoload.php';
          $client = new MongoDB\Client("mongodb://localhost:27017");
          $db = $client->Progess;
          $collection = $db->Listening2;
      ...
      <div class="row justify-content-center">
        <ul id="accordion" class="accordion">
          <li>
            ...
            <ul class="submenu">
              <div class="wp-text-submenu" style="min-height: 100px;  display: table-cell; /* Important */ 
                ...
                <p class="ps-3 pe-3 text-white">Listen to the audio and do the exercises.
              </div>
              </p>
            </ul>
          </li>
          <!-- <li>
            ...
            <ul class="submenu">
              <li class="text-white">
                <h1 class="header-sub mt-0 pt-3">Listening B2: A bussiness interview</h1>
                <h6 class="sub-header-sub ps-3 text-white pb-4">Match the times to the phrases.</h6>
              </li>
              <li>
                <div>
          ...
          <li>
            <div class="link"><i class="fa fa-mobile"></i>Listening topic: A lecture about an experiment<i
                class="fa fa-chevron-down"></i></div>
            <ul class="submenu">
              <div class="col-12 justify-content-center">
                <img src="./assets/images/imgListening2.jpg" class="align-item-center"
                  style="max-width: 800px; margin: 0 auto; display: block;" alt="">
                <audio controls>
                  <source src="./assets/audio/audioListening2.mp3" type="audio/mpeg">
                </audio>
      ...
      <div class="pagination-style text-center mt-5">
        <ul class="d-flex justify-content-center">
          <li> <a href="Listening.php" disabled="">
              <span class="fa fa-angle-double-left" aria-hidden="true"></span>
            </a>
          </li>
          <li><a href="Listening.php">1</a></li>
          <li>
            <a class="active" href="Listening_02.php">2</a>
          </li>
          <!-- <li>
            <a href="#page">3</a>
          </li> -->
          <li>
            <a href="#page" class="not-allowed"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
            </a>
          </li>
        </ul>
      </div>
