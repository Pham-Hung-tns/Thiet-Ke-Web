...
const quizdata=[
      {
        question:"Someone who starts a business",
        options:["the founder", "the character", "the interview"],
        answer:"the founder",
        category:1
      },
      {
        question:"Already officially recognised and accepted",
        options:["success", "pre-approved", "employee"],
        answer:"pre-approved",
        category:2
      },
      {
        question:"Far away from towns or other populated places",
        options:["a remote area", "a area", "a land"],
        answer:"a remote area",
        category:3
      },
      {
        question:"A difficult or challenging situation",
        options:["a predicament", "obvious", "annoyed"],
        answer:"a predicament",
        category:1
      },
      {
        question:"Easy to understand or notice",
        options:["stupid", "intelligent", "obvious"],
        answer:"obvious",
        category:2
      },
      {
        question:"Anna ...",
        options:["started the company and manages it now", "didn't start the company but manages it now"],
        answer:"started the company and manages it now",
        category:3
      },
      {
        question:"The app ...",
        options:["is for parents to learn from","is for students who want to find a tutor"],
        answer:"is for students who want to find a tutor",
        category:2
      },
      {
        question:"Many parents ...",
        options:["don't have the time or knowledge to help with their children's homework","don't want to help with their children's homework"],
        answer:"don't have the time or knowledge to help with their children's homework",
        category:3
      },
      {
        question:"The app ...",
        options:["has student exercises on it", "offers live online support from tutors", "is only for people in remote areas"],
        answer:"offers live online support from tutors",
        category:1
      },
      {
        question:"On the app, tutors who live in remote areas ...",
        options:["often charge higer rates", "don't like to work too much", "often charge lower rates"],
        answer:"false",
        category:2
      },
      {
        question:"The app ...",
        options:["is already popular", "is not very successful"],
        answer:"is already popular",
        category:3
      },
      {
        question:"The audio is too easy?",
        options:["true", "false"],
        answer:"true",
        category:1
      }
