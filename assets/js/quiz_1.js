...
const quizdata=[
      {
        question:"to move something suddenly",
        options:["to create", "to flick", "to squint"],
        answer:"to flick",
        category:1
      },
      {
        question:"How does Mr Carter feel while he's talking to Sam in this scene?",
        options:["Angry", "Nervous", "Excited"],
        answer:"Nervous",
        category:2
      },
      {
        question:"Why has Mr Carter come to his house?",
        options:["Because his son has had problems at school", "Because his son needs a holiday"],
        answer:"Because his son has had problems at school",
        category:3
      },
      {
        question:"Sam: Lives on the farm",
        options:["true", "false", "NI"],
        answer:"true",
        category:1
      },
      {
        question:"Mr Carter: Owns the farm",
        options:["true", "false"],
        answer:"true",
        category:2
      },
      {
        question:"Mr Carter's soon: Doesn't often come to the farm",
        options:["true", "false","NI"],
        answer:"false",
        category:3
      },
      {
        question:"Sam: Works with his hand",
        options:["true","false", "NI"],
        answer:"true",
        category:2
      },
      {
        question:"Mr Carter's soon: Has do something wrong",
        options:["true", "false", "NI"],
        answer:"false",
        category:3
      },
      {
        ...
        options:["He might leave on foot", "He might do something dangerous while riding", "He might break the fences"],
        answer:"He might do something dangerous while riding",
        category:1
      },
      {
        question:"What can we guess about Mr Carter?",
        options:["He's rich", "He word hard", "He loves horses"],
        answer:"He's rich",
        category:2
      },
      {
        question:"Why does Sam not take holidays from work?",
        options:["He can't afford it", "He hasn't finished repairing the fences", "He feel safer on the farm"],
        answer:"He feel safer on the farm",
        category:3
      },
      {
        question:"What is Sam's reaction to his letters",
        options:["Uninterested","Surprised","Afraid", "Curious"],
        answer:"Uninterested",
        category:1
      }
    ];
