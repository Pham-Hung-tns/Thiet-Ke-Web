...
const quizdata=[
      {
        question:"We urgently need to ... action about the plastic waste problem",
        options:["take", "role", "term", "amount"],
        answer:"take",
        category:1
      },
      {
        question:"The hurricane had a devastating ... on the island.",
        options:["rule", "revese", "impact", "employee"],
        answer:"impact",
        category:2
      },
      {
        question:"The filmmakers ... a shocking discovery in the Pacific.",
        options:["take", "make", "do"],
        answer:"make",
        category:3
      },
      {
        question:"The answer was painfully ... to everyone in the room",
        options:["private", "obvious", "public"],
        answer:"obvious",
        category:1
      },
      {
        question:"Everyone has a role to play in this situation",
        options:["true", "false"],
        answer:"true",
        category:2
      },
      {
        question:"It's is not too soon to reverse the tide and fix the problem",
        options:["true", "false", "NI"],
        answer:"false",
        category:3
      },
      {
        question:"This is a short-... solution. It won't work forever",
        options:["term", "title", "titles", "short"],
        answer:"term",
        category:2
      },
      {
        question:"There is a staggering ... of plastic in the world.",
        options:["a lot of", "count", "high", "amount"],
        answer:"amount",
        category:3
      },
      {
        question:"The results are disastrous, but it isn't too late to change",
        options:["true", "false"],
        answer:"true",
        category:1
      },
      {
        question:"... But the film only present the negative side",
        options:["true", "false", "NI"],
        answer:"false",
        category:2
      },
      {
        question:"The bottles drink is fill by water and transported to people",
        options:["true", "false", "NI"],
        answer:"NI",
        category:3
      },
      {
        question:"We live in a world full of plastic, and ... a samll proportion is ...",
        options:["recycled, small", "a lot of, fill", "small, upcycled", "small, recycled"],
        answer:"small, recycled",
        category:1
      }
    ];
