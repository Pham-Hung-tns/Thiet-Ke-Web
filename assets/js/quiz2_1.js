document.addEventListener('DOMContentLoaded', function () {
	...
	// CREATE QUESTIONS
	var questions = [
		new Question('to almost close your eyes, often because of a bright light', ['to squint', 'to flick', 'to create'], 'to squint'),
		new Question('a small area', ['areas', 'a patch', 'a highland'],'a patch'),
		new Question('a book of maps', ['a map', 'an atlas', 'an geography book'], 'an atlas')
	];
