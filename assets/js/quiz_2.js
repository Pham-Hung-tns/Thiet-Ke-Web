...
const quizdata=[
      {
        question:"to happend before a later event",
        options:["to create", "to pre-date", "to squint"],
        answer:"to pre-date",
        category:1
      },
      {
        question:"Joseph Campbell's original book cover has links to the Star Wars films",
        options:["true", "false"],
        answer:"false",
        category:2
      },
      {
        question:"The Ancient Greeks also based their stories on Campbell's ideas.",
        options:["true","false"],
        answer:"false",
        category:3
      },
      {
        question:"Other film directors after George Lucas have carefully",
        options:["true", "false", "NI"],
        answer:"true",
        category:1
      },
      {
        question:"Obi-Wan Kenobi sends Luke a message and starts his adventure.",
        options:["true", "false"],
        answer:"false",
        category:2
      },
      {
        question:"The hero is always willing to accept the call to adventure.",
        options:["true", "false","NI"],
        answer:"false",
        category:3
      },
      {
        question:"The hero often finds strength from some kind of loss",
        options:["true","false", "NI"],
        answer:"true",
        category:2
      },
      {
        question:"Critics of 'Star Wars: Episode VII – The Force Awakens' complained that the film was ...",
        options:["unoriginal", "original", "origin"],
        answer:"unoriginal",
        category:3
      },
      {
        question:"The front cover of later ... of the book 'The Hero with a Thousand Faces' had Luke Skywalker on the front cover",
        options:["edition", "editions", "edit"],
        answer:"editions",
        category:1
      },
      {
        question:"When heroes are finally ... , they return from the special world, changed by their experiences forever",
        options:["succeed", "successfully", "successful"],
        answer:"successful",
        category:2
      },
      {
        question:"When Luke loses his mentor, he finds the ... he needs for the rest of his journey.",
        options:["strong", "strongest", "strength"],
        answer:"strength",
        category:3
      },
      {
        question:"The hero has to overcome obstacles on the way, such as ... or loss.",
        options:["die", "death", "dead"],
        answer:"death",
        category:1
      }
    ];
