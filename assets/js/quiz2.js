document.addEventListener('DOMContentLoaded', function () {
	...
	// CREATE QUESTIONS
	var questions = [
		new Question('A Plastic Ocean is a film to... you think', ['make', 'have', 'create'], 'make'),
		new Question('What is the largest animal on the planet?', ['Human', 'Elephant', 'Blue whale'], 'Blue whale'),
		new Question('Drink bottles are made by... ', ['plastic', 'cotton', 'coal'], 'plastic')
	];
