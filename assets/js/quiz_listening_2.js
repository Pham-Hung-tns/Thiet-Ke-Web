...
const quizdata=[
      {
        question:"The pitch drop experiment is ...",
        options:["the oldest experiment in history", "the oldest experiment that is still running today"],
        answer:"the oldest experiment that is still running today",
        category:1
      },
      {
        question:"The creator of the experiment wanted to ...",
        options:["show that common substances have extraodinary properties","show the dangers of everyday materials", "have an experiment that lasted a long time"],
        answer:"show that common substances have extraodinary properties",
        category:2
      },
      {
        question:"Pitch is a substance ...",
        options:["that looks solid but is actually liquid", "that looks liquid but is actually solid", "that doesn't appear to be liquid or solid"],
        answer:"that looks solid but is actually liquid",
        category:3
      },
      {
        question:"The first time a drop of pitch fell was ... after the experiment began",
        options:["eight years ", "three years", "forty years"],
        answer:"eight years",
        category:1
      },
      {
        question:"Which of the following sentences is not true about Professor John Mainstone?",
        options:["He took over the experiment in 1927", "He took over the experiment in 1972", "He never saw the pitch drop"],
        answer:"He took over the experiment in 1927",
        category:2
      },
      {
        question:"In the year 2000, ...",
        options:["the tenth drop of pitch fell", "an electricity failure meant the pitch drop was not filmed", "the ninth drop of pitch fell"],
        answer:"an electricity failure meant the pitch drop was not filmed",
        category:3
      },
      {
        question:"When pitch is at room temperature, you can break it",
        options:["diffcultly", "easily", "with a fan"],
        answer:"easily",
        category:2
      },
      {
        question:"Professor Parnell put pitch into a glass funnel, let it cool, then turned it ... and cut off the top.",
        options:["upside down", "turn right", "bend up"],
        answer:"upside down",
        category:3
      },
      {
        question:"In total, only ... have fallen from the funnel.",
        options:["1 drops", "10 drops", "9 drops"],
        answer:"9 drops",
        category:1
      },
      {
        question:"The next pitch drop is expected to fall in ...",
        options:["the 2021s", "the 2012s", "2020s"],
        answer:"2020s",
        category:2
      },
      {
        question:"In 1988, the scientist responsible for the experiment missed seeing the pitch drop by ...",
        options:["5 minutes", "6 minutes", "7 minutes"],
        answer:"5 minutes",
        category:3
      },
      {
        question:"The speaker notes it's interesting how news about a slow experiment can spread ...",
        options:["fast", "slow", "very slow", "normal"],
        answer:"fast",
        category:1
      }
    ];
...
function returnOptionList(opts, i){
  ...
  var optionHtml='<li class="myoptions ps-4 pt-4">'+
...
function renderResult(resultList){ 
 ...
 // document.getElementById("dat").innerHTML = countAnswers(result)[0];
