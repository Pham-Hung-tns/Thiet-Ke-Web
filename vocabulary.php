  ...
  <header id="site-header" class="fixed-top">
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="index1.php"><i class="fas fa-graduation-cap"></i>Edu School
        </a>
    ...
    <div class="w3l-breadcrumb py-lg-5">
      <div class="container pt-4 pb-sm-4">
        ...
        <ul class="breadcrumbs-custom-path">
          ...
          <li class="active"><i class="fas fa-angle-right"></i>Vocabulary</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <div class="w3l-grids-block-5 py-5">
    <div class="container py-md-5 py-4">
      <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
        ...
        <h3 class="title-style">Lesson 1</h3>
      </div>
      <div class="row justify-content-center">
        <ul id="accordion" class="accordion">
            ...
            <ul class="submenu">
              <div class="wp-text-submenu" style="min-height: 100px;  display: table-cell; /* Important */ 
                ...
                <p class="ps-3 pe-3 text-white">Do the preparation task first. Then read the text and do the exercises.
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Dignissimos fuga accusantium voluptatum neque
                  blanditiis? Maiores fugiat ut enim quidem placeat!
              </div>
              </p>
            </ul>
          </li>
          <li>
            ...
            <ul class="submenu">
              <li class="text-white">
                <h1 class="header-sub mt-0 pt-3">Reading A1: A poster at work – preparation</h1>
          ...
          <li>
            ...
            <ul class="submenu">
              <div class="col-12 justify-content-center">
                <img src="./assets/images/bg1.jpg" class="align-item-center"
                  style="max-width: 800px; margin: 0 auto; display: block;" alt="">
                <p class="text-white ps-3 pe-3">Come and join our lunchtime yoga class with experienced yoga teacher
                  Divya Bridge!
                  ...
                  We can only take a maximum of 20 in the room, so book now!</p>
              </div>
            </ul>
          </li>
          <li>
